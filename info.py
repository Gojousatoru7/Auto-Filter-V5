...
API_ID = int(environ.get('API_ID', '25489101'))
API_HASH = environ.get('API_HASH', '2147eb8788adb76a522048dee893090f')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001770137921')).split()]
